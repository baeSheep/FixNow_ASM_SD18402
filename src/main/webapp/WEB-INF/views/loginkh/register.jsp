...
.banner {
	background-image:
		url('${pageContext.request.contextPath}/img/nhabep.webp');
	...
	<div
		...
		<div class="form-container p-5 rounded shadow-lg">
			...
			<form action="/home/register" method="post">
				...
				<div class="mb-3">
					<label class="form-label" for="first-name">Họ</label> <input
						type="text" id="firstname" name="firstname" class="form-control"
						placeholder="Họ" required />
				</div>
				<div class="mb-3">
					<label class="form-label" for="last-name">Tên</label> <input
						type="text" id="lastname" name="lastname" class="form-control"
						placeholder="Tên" required />
				</div>

				<div class="mb-3">
					<label class="form-label" for="email">Địa chỉ Email</label> <input
				...
				<div class="mb-3">
					<label class="form-label" for="confirm-password">Xác nhận
						mật khẩu</label> <input type="password" id="confirm-password"
			...
			<p class="mt-3 text-center">
				Bạn chưa có tài khoản? <a href="/home/login" class="text-primary">Đăng
					Nhập</a>
			</p>
		</div>
	</div>
